...
const successExampleRef = {
  ...
  ArticlesPageSuccessExample:
    '#/components/examples/ArticlesPageSuccessExample',
  ArticlesAllSuccessExample: '#/components/examples/ArticlesAllSuccessExample',
  ArticleCreatedSuccessExample:
    '#/components/examples/ArticleCreatedSuccessExample',
  ArticleUpdatedSuccessExample:
    '#/components/examples/ArticleUpdatedSuccessExample',
} as const;

const successResponse = (
  description: string,
  exampleKey: keyof typeof successExampleRef,
) => ({
  description,
  content: {
    'application/json': {
...
const errorResponse = (
  status: keyof typeof errorExamples,
  description: string,
) => ({
  description,
  content: {
    ...
    schemas: {
      ApiSuccess: {
        ...
        properties: {
          ...
          requestId: {
            type: 'string',
            example: '4f47e2c6-137f-45dd-a9f9-e4f61c9ab719',
          },
          data: {},
        },
  ...
  paths: {
    '/health': {
      get: {
        ...
        responses: { 200: successResponse('OK', 'HealthSuccessExample') },
      },
    },
    '/api/auth/login': {
      post: {
    ...
    '/api/articles/all': {
      get: {
        ...
        responses: {
          200: successResponse('Article list', 'ArticlesAllSuccessExample'),
        },
      },
    },
    '/api/articles/{id}': {
