...
import { z } from 'zod';
import { batchDeleteSchema, createUserSchema, listQuerySchema, loginSchema, refreshTokenSchema, updateUserSchema } from '../src/modules/user/dto/user.dto';
import { articleBatchDeleteSchema, articleListQuerySchema, createArticleSchema, updateArticleSchema } from '../src/modules/article/dto/article.dto';
...
writeFileSync(resolve(process.cwd(), 'openapi.generated.json'), JSON.stringify(document, null, 2), 'utf8');
